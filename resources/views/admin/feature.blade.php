...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Our Features</h4>
                    ...
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            @foreach ($features as $feature)
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td><img src="{{asset('uploads/features/'.$feature->icon)}}" alt="Thumbnail Image" id="" class="img-thumbnail"></td>
                                    <td><strong>{{$feature->title}}</strong></td>
                                    <td>{{$feature->text}}</td>
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" onclick="editt({{$feature->id}});" class="btn btn-outline-success"><i class="feather icon-upload mr-2"></i> Update</button>
                                            &nbsp;
                                            <button type="button" onclick="del({{$feature->id}});" class="btn btn-outline-danger"><i class="feather icon-trash-2 mr-2"></i> Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="modal-body">
                    <div class="col-12">
                        <div class="form-group mb-3">
                             ...
                             <input type="text" class="form-control" name="title" value="" id="inputText" placeholder="Enter Client Name" required>
                         </div>
                     </div>
                    <div class="col-12">
                        <div class="form-group mb-3">
                             <label for="">Text</label>
                             <input type="text" class="form-control" name="text" value="" id="inputText" placeholder="Enter Client Name" required>
                         </div>
                     </div>
                    <div class="col-12">
                        <div class="form-group mb-3">
                             ...
                             <input type="file" class="form-control" id="logo" name="icon">
                         </div>
                     </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-12">
                        <div class="form-group mb-3">
                             <label for="">Title</label>
                             <input type="text" class="form-control cname" name="title" value="" id="inputText" placeholder="Enter Client Name" required>
                         </div>
                     </div>
                    <div class="col-12">
                        <div class="form-group mb-3">
                             <label for="">Text</label>
                             <input type="text" class="form-control ctext" name="text" value="" id="inputText" placeholder="Enter Client Name" required>
                         </div>
                     </div>
                    <div class="col-12">
                        <div class="form-group mb-3">
...
@section('scripts')
    ...
    function editt(value) {
            ...
            $.ajax({
                type: "get",
                url: "{{url('admin/get-feature')}}/"+value,
                success: function (response) {
                    $('#exampleModalCenter1').modal('show');
                    $('.cname').val(response['data']['title']);
                    $('.ctext').val(response['data']['text']);
                    $('#cd_logo').attr('src', "/uploads/features/"+response['data']['icon']);
                    $('.editform').attr('action', "{{url('admin/update-feature')}}/"+value);
            ...
            $.confirm({
                ...
                buttons: {
                    tryAgain: {
                        ...
                        btnClass: 'btn-red',
                        action: function(){
                          window.open("{{url('admin/delete-feature')}}/"+value, "_self");
                        }
                    },
                    cancelAction: {
                        text: 'Cancel',
