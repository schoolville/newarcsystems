    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{url('admin/update-collections/'.$collections->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        <div class="col-12">
                           <div class="form-group mb-3">
                                <label for="">Content</label>
                                <textarea id="tinymce-example" name="text">{{$collections->text}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                 ...
                                 <img src="{{asset('/uploads/collections/'.$collections->image)}}" alt="Thumbnail Image" id="d_logo" class="img-thumbnail">
